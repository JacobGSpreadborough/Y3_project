...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/phonegap.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/cross_platform_trends.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/AVFAudio.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/ape_fwk_audio.png}
